...
CREATE TABLE `accommodation` (
  ...
  CONSTRAINT `fk_acc_exp` FOREIGN KEY (`Experience_ID`) REFERENCES `experience` (`Experience_ID`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `activity` (
  ...
  CONSTRAINT `fk_act_exp` FOREIGN KEY (`Experience_ID`) REFERENCES `experience` (`Experience_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `attraction` (
  ...
  CONSTRAINT `fk_attr_exp` FOREIGN KEY (`Experience_ID`) REFERENCES `experience` (`Experience_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `booking` (
  ...
  `Package_Option_ID` int(11) NOT NULL,
  `Group_Trip_ID` int(11) DEFAULT NULL,
  PRIMARY KEY (`Booking_ID`),
  KEY `fk_bk_traveller` (`Traveller_ID`),
  KEY `fk_bk_package_option` (`Package_Option_ID`),
  KEY `fk_bk_group_trip` (`Group_Trip_ID`),
  CONSTRAINT `fk_bk_group_trip` FOREIGN KEY (`Group_Trip_ID`) REFERENCES `group_trip` (`Group_Trip_ID`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_bk_package_option` FOREIGN KEY (`Package_Option_ID`) REFERENCES `package_option` (`Package_Option_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `destination` (
  ...
  CONSTRAINT `fk_dest_exp` FOREIGN KEY (`Experience_ID`) REFERENCES `experience` (`Experience_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `feedback` (
  ...
  KEY `fk_fb_booking` (`Booking_ID`),
  KEY `fk_fb_package_option` (`Package_Option_ID`),
  CONSTRAINT `fk_fb_booking` FOREIGN KEY (`Booking_ID`) REFERENCES `booking` (`Booking_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_fb_package_option` FOREIGN KEY (`Package_Option_ID`) REFERENCES `package_option` (`Package_Option_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `package` (
  ...
  CONSTRAINT `fk_pkg_agency` FOREIGN KEY (`Agency_ID`) REFERENCES `agency` (`Agency_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `package_option` (
  `Package_Option_ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`Package_Option_ID`),
  KEY `fk_po_package` (`Package_ID`),
...
CREATE TABLE `package_option_experience` (
  `Package_Option_ID` int(11) NOT NULL,
  `Experience_ID` int(11) NOT NULL,
  PRIMARY KEY (`Package_Option_ID`,`Experience_ID`),
  ...
  CONSTRAINT `fk_poe_option` FOREIGN KEY (`Package_Option_ID`) REFERENCES `package_option` (`Package_Option_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `package_option_flight` (
  ...
  `Seat_Class` varchar(50) NOT NULL,
  PRIMARY KEY (`Package_Option_ID`,`Flight_ID`),
  ...
  CONSTRAINT `fk_pof_option` FOREIGN KEY (`Package_Option_ID`) REFERENCES `package_option` (`Package_Option_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `package_option_service` (
  ...
  PRIMARY KEY (`Package_Option_ID`,`Product_Service_ID`),
  KEY `fk_pos_service` (`Product_Service_ID`),
  CONSTRAINT `fk_pos_option` FOREIGN KEY (`Package_Option_ID`) REFERENCES `package_option` (`Package_Option_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `restaurant` (
  ...
  CONSTRAINT `fk_rest_exp` FOREIGN KEY (`Experience_ID`) REFERENCES `experience` (`Experience_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-09 16:41:54
